                            ...
                            <div className="card w-50">
                                ...
                                <div className="card-footer p-2 d-flex justify-content-between">
                                    <div className="d-flex flex-column">
                                        {project.link && (
                                            <a href={project.link} target="_blank" className="btn text-center mb-1">
                                                View Live Project <FaArrowUpRightFromSquare />
                                            </a>
                                        )}
                                        <a href={project.github} target="_blank" className="btn text-center mt-1">
                                    ...
                                    <div>
                                        ...
                                        {/* {project.stack.map((stack, idx) => (
                                            <span key={idx} className={`icon ${stack}`}>
