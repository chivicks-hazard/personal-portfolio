import gdgfuto from "/images/gdgfuto.jpg";
import gdg from "/images/gdg.jpg";
import ieee from "/images/ieee.jpeg";
import hack4futo from "/images/hack4futo.jpg";
                ...
                <div className="container mx-auto mt-20">
                    ...
                    >
                        ...
                        <div className="col-span-1 row-span-1 p mx-auto md:w-1/2 text-wrap">
                            <h2 className="text-3xl md:text-4xl mb-2 text-aliceblue">
                                Google Developer Groups: Federal University of
                                Technology, Owerri
                            </h2>
                            ...
                            <p className="text-xl text-wrap mt-5">
                                The Google Developers Group Federal University
                                of Technology - Owerri is a dynamic community of
                                students passionate about technology and eager
                                to harness their skills to create a positive
                                impact and solve local challenges.
                                <br />
                                {/* <br /> */}
                                We are a student-driven tech community with a
                                mission to positively influence as many students
                                as possible for as long as possible. Our core
                                belief is that tech education can be fun, as
                                long as you're learning with us. As a tight-knit
                                group of friends and fellow students, we engage
                                in the collective pursuit of learning, sharing
                    ...
                    >
                        ...
                        <div className="col-span-1 row-span-1 p mx-auto md:w-1/2 text-wrap">
                            ...
                            <p className="text-xl text-wrap mt-5">
                                ...
                                professional organization and is a public
                                charity dedicated to advancing technological
                                innovation and excellence for the benefit of
                                humanity. IEEE and its members inspire a global
                                community through its highly cited publications,
                                conferences, technology standards, and
                                professional and educational activities. IEEE is
                                the trusted “voice” for engineering, computing
                                and technology information around the globe.
                                <br />
                                <br />
                                <span className="text-ghostwhite font-medium">
                                    PS:{" "}
                                </span>{" "}
                                I'm a member of the student branch in FUTO,
                                which also makes me an IEEE member 😁
                            </p>
                        </div>
                    </section>
                    <section
                    ...
                    >
                        ...
                        <div className="col-span-1 row-span-1 p mx-auto md:w-1/2 text-wrap">
                            ...
                            <p className="text-xl text-wrap mt-5">
                                Empowering FUTO students, innovators, and devs
                                tackle global challenges in Fintech,
                                sustainability, education, digital inclusion and
                                the future of work.
                            </p>
                        </div>
                    </section>
